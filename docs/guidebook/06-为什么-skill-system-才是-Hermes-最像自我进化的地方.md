...
![skill system 作为程序化记忆](./assets/hermes-article-06-imagegen2-skill-system-procedural-memory.png)

*图：这张图把 skill system 画成一种可演化的操作资产：经验不只被记成事实，还可以被整理成带说明、模板、脚本、资产和校验边界的 procedural memory。*
